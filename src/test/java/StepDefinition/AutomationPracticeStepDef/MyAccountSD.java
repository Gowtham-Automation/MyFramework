...
public class MyAccountSD extends automationPracticePageObjects.MyAccountPageObject{
	automationPracticePageObjects.ProductPageObject productPageObject;
    ...
    public void the_customer_adds_a_product_to_the_cart() throws Exception {
        ...
        searchProduct();
        Thread.sleep(1000);
        productPageObject = new automationPracticePageObjects.ProductPageObject();
